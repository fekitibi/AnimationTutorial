...
// Macro for matrix matrix dot product
...
// Macro matrix point dot product
...
// Macro for calculating the Minor of one element of a matrix
// (input array of loats,and three rows and three columns to cut from the matrix )
